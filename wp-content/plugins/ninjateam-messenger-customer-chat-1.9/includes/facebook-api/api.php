...

{
...

  {
    ...
    $this->APP_ID=get_option('njt_customer_chat_app_id');//'983715691729450';//get_option('njt_customer_chat_app_id');

    $this->sercet=get_option('njt_customer_chat_app_serect');//'320a2c9ab05dd575883e6acfbdf0cdd8';//get_option('njt_customer_chat_app_serect');
